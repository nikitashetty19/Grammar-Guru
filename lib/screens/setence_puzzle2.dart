...
import 'dart:convert';
import 'package:ipd/repositories/attempt_repo.dart';
...
class _SentencePuzzleState extends State<SentencePuzzle> {
  ...
  final AttemptPunctuationRepository _repository =
      AttemptPunctuationRepository();
  ...
  Future<void> sendDataToBackend() async {
    var url = Uri.parse('http://10.0.2.2:8000/process-input/');
